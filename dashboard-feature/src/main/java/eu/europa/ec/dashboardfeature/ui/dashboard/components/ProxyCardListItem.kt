...
@Composable
internal fun ProxyCardListItem(
    onClick: () -> Unit,
    modifier: Modifier = Modifier
) {

    val colorsThatLookLikeDisabled = CardDefaults.cardColors().copy(
    ...
    WrapCard(
        ...
        Column(
            ...
            Box(
                ...
                ScalableText(
                    text = stringResource(id = R.string.dashboard_document_proxy_title),
            ...
            VSpacer.Small()
            Text(
                text = stringResource(id = R.string.dashboard_document_proxy_description),
