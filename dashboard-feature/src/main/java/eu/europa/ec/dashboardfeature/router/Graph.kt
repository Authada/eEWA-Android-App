...
import eu.europa.ec.dashboardfeature.ui.proxy.ProxyPidExplanationScreen
...
fun NavGraphBuilder.featureDashboardGraph(navController: NavController) {
    navigation(
        ...
        composable(
            route = DashboardScreens.ProxyExplanation.screenRoute
        ) {
            ProxyPidExplanationScreen(navController)
        }
    }
}