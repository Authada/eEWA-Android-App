...
package eu.europa.ec.commonfeature.ui.preview
...
open class DocumentUiPreviewParameter : PreviewParameterProvider<DocumentUi> {
    override val values: Sequence<DocumentUi> = sequenceOf(
    ...
    companion object {
        ...
        val DRIVERS_LICENSE_NO_METADATA = DocumentUi(
            documentId = "1",
        ...
        val GENERIC_EAA: DocumentUi = DocumentUi(
            documentId = "1",
