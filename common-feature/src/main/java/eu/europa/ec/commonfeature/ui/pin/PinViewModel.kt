...
sealed class Event : ViewEvent {
    ...
    data object OnPasswordVisibilityChanged : Event()
...
class PinViewModel(
    ...
    override fun handleEvents(event: Event) {
        when (event) {
            ...
            is Event.GoBack -> setEffect { Effect.Navigation.GoBack }
    ...
    private fun setupReenterPhase(enteredPin: String) {
        ...
        setState {
            copy(
                ...
                pin = "",
                resetPin = true,
                title = resourceProvider.getString(R.string.quick_pin_create_reenter_title),
                subtitle = calculateSubtitle(newPinState)
            )
        }
    }
